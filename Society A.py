...
def print_to_file(filename, unique_list_finished):
    ...
    f.close()
    print(
        "[+] Guardando diccionario... \033[1;31m"
        + filename
        + "\033[1;m, counting \033[1;31m"
        + str(lines)
        + " words.\033[1;m"
    )
    inspect = input("> Impresion de alta velocidad? (Y/n) : ").lower()
    if inspect == "y":
        try:
    ...
    print(
        "[+] Ahora tu diccionario  \033[1;31m"
        + filename
        + "\033[1;m esta listo para un ataque"
    )


def print_cow():
    print(" ___________ ")
    print(" \033[07m  Society A! \033[27m                # \033[07mC\033[27mommon")
    print("      \                     # \033[07mU\033[27msuario")
    print("       \   \033[1;31m,__,\033[1;m             # \033[07mC\033[27montraseñas")
    print(
        "        \  \033[1;31m(\033[1;moo\033[1;31m)____\033[1;m         # \033[07mP\033[27merfil"
    )
    print("           \033[1;31m(__)    )\ \033[1;m  ")
    print(
        "           \033[1;31m   ||--|| \033[1;m\033[05m*\033[25m\033[1;m      [ Azael C.L | Society A ]"
    )
    print(28 * " " + "[ Si piensas que la tecnología puede solucionar tus problemas de seguridad, está claro que ni entiendes los problemas ni entiendes la tecnología ]\r\n")
...
def version():
    ...
    print("	* Herramienta creada por Azael C.L")
    print("	* Society A\r\n")
    print("	Contactame en facebook:https://www.facebook.com/azael.lorenzo.3975012/./\r\n")
...
def interactive():
    ...
    print("\r\n[+] Inserta la información sobre la víctima para crear un diccionario")
    print("[+] Si no conoce toda la información, simplemente presione enter cuando se le solicite.\r\n")
    ...
    while len(name) == 0 or name == " " or name == "  " or name == "   ":
        print("\r\n[-]  Necesitas ingresar un nombre al menos")
        name = input("> Nombre: ").lower()
    profile["name"] = str(name)

    profile["surname"] = input("> Apellido: ").lower()
    profile["nick"] = input("> Apodo: ").lower()
    birthdate = input("> Fecha de cumpleaños (DDMMYYYY): ")
    while len(birthdate) != 0 and len(birthdate) != 8:
        print("\r\n[-] Tienes que ingresar 8 digitos para el cumpleaños D:Dia M:Mes Y:Año")
        birthdate = input("> Fecha de cumpleaños (DDMMYYYY): ")
    profile["birthdate"] = str(birthdate)

    print("\r\n")

    profile["wife"] = input("> Nombre de amig@ o novi@: ").lower()
    profile["wifen"] = input("> Apodo de su amig@ o novi@ : ").lower()
    wifeb = input("> Cumpleaños de amig@ o novio (DDMMYYYY): ")
    while len(wifeb) != 0 and len(wifeb) != 8:
        print("\r\n[-] Tienes que ingresar 8 digitos para el cumpleaños D:Dia M:Mes Y:Año")
        wifeb = input("> Cumpleaños de amig@ o novi@ (DDMMYYYY): ")
    profile["wifeb"] = str(wifeb)
    print("\r\n")

    profile["kid"] = input("> Nombre de herman@: ").lower()
    profile["kidn"] = input("> Apodo de herman@: ").lower()
    kidb = input("> Cumpleaños de su herman@ (DDMMYYYY): ")
    ...
    profile["pet"] = input("> Nombre de mascota: ").lower()
    profile["company"] = input("> Nombre de (comida,pelicula o cancion) favorita: ").lower()
    print("\r\n")

    profile["words"] = [""]
    words1 = input(
        "> ¿Quieres agregar algunas palabras clave sobre la víctima? Y/[N]: "
    ).lower()
    words2 = ""
    if words1 == "y":
        words2 = input(
            "> Introduzca las palabras, separadas por comas. [es decir. facebook, jugo, negro, perrito], se eliminarán los espacios: "
        ).replace(" ", "")
    profile["words"] = words2.split(",")

    profile["spechars1"] = input(
        "> ¿Quieres agregar caracteres especiales al final de las palabras? Y/[N]: "
    ).lower()

    profile["randnum"] = input(
        "> ¿Quieres agregar algunos números aleatorios al final de las palabras? Y/[N]:"
    ).lower()
    profile["leetmode"] = input("> ¿Modo Leet? (i.e. leet = 1337) Y/[N]: ").lower()
...
def generate_wordlist_from_profile(profile):
    ...
    print("[+] Ordenando lista y eliminando duplicados...")
